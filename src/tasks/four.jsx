...
class ChallengeFour extends Component{
  ...
  render(){
    return (
      <div className="ch4" style={{
        backgroundColor: this.state.isOn ? '#FCE7F3' : '#161d2e',
        color: this.state.isOn ? 'black' : 'white',
      }}>
        <BackToHome />
        <div className="level">
          <div>
          ...
          <button onClick={this.changeTheme} className="ch4__dark-mode-btn">
            <Moon fontSize={30} />
          </button>
        </div>
